...
wire [3:0] enable;
wire [63:0] start_send_time_0;
wire [63:0] start_send_time_1;
wire [63:0] start_send_time_2;
wire [63:0] start_send_time_3; 
...
port_mux
   #(
      ...
      .select                               (enable[0]),
		...
		.start_send_time                      (start_send_time_0),
		
		.want_reset                           (want_reset[0]),
...
port_mux
   #(
      ...
      .select                               (enable[1]),
		...
		.counter_val									(counter_val),
		.start_send_time                      (start_send_time_1),
		
		.want_reset                           (want_reset[1]),
...
port_mux
   #(
      ...
      .select                               (enable[2]),
		...
		.counter_val									(counter_val),
		.start_send_time                      (start_send_time_2),
		
		.want_reset                           (want_reset[2]),
      // --- Misc
      .clk                                  (clk),
      .reset                                (reset)
   );
...
port_mux
   #(
      ...
      .select                               (enable[3]),
		...
		.counter_val									(counter_val),
		.start_send_time                      (start_send_time_3),
		
		.want_reset                           (want_reset[3]),
      // --- Misc
      .clk                                  (clk),
      .reset                                (reset)
   );
...
generic_hw_regs #(
      ...
      .hardware_regs                         ({start_send_time_3,start_send_time_2,start_send_time_1,start_send_time_0}), 
