...
wire [63:0] start_rec_time_0;
wire [63:0] start_rec_time_1;
wire [63:0] start_rec_time_2;
wire [63:0] start_rec_time_3;
...
pkt_capture_main
   #(
      ...
      .time_last_3                        (time_last_3),
		...
		.start_rec_time_0							(start_rec_time_0),
		.start_rec_time_1							(start_rec_time_1),
		.start_rec_time_2							(start_rec_time_2),
		.start_rec_time_3							(start_rec_time_3),
      // --- Misc
      .clk                                (clk),
      .reset                              (reset)
   );
...
generic_hw_regs #(
      ...
      .hardware_regs                         ({	
							time_last_3[TIME_WIDTH-1:32],time_last_3[31:0],
							time_first_3[TIME_WIDTH-1:32],time_first_3[31:0],
							{(64 - BYTE_CNT_WIDTH){1'b0}}, byte_cnt_3[BYTE_CNT_WIDTH-1:32],byte_cnt_3[31:0],
                     pkt_cnt_3,
		
							time_last_2[TIME_WIDTH-1:32],time_last_2[31:0],
							time_first_2[TIME_WIDTH-1:32],time_first_2[31:0],
							{(64 - BYTE_CNT_WIDTH){1'b0}}, byte_cnt_2[BYTE_CNT_WIDTH-1:32],byte_cnt_2[31:0],
                     pkt_cnt_2,
...
generic_hw_regs #(
      ...
      .hardware_regs                         ({start_rec_time_3,start_rec_time_2,start_rec_time_1,start_rec_time_0}),
