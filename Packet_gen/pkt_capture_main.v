...
module pkt_capture_main
   ...
   (
     ...
     input [COUNTER_WIDTH-1:COUNTER_FRACTION] counter_val,
	  output [63:0] 						start_rec_time_0,
	  output [63:0] 						start_rec_time_1,
	  output [63:0] 						start_rec_time_2,
	  output [63:0] 						start_rec_time_3,
   ...
   integer              i;
	...
	reg [63:0]           start_rec_time[NUM_MACS-1:0];
               ...
               if (capture_pkt &&
                  ...
                  if (first_pkt[src_held]) begin
                     time_first[src_held] <= fifo_out_data;
							start_rec_time [src_held] <= counter_val;
                  end
   ...
   assign time_last_3 = time_last[3];
	...
	assign start_rec_time_0 = start_rec_time[0];
	assign start_rec_time_1 = start_rec_time[1];
	assign start_rec_time_2 = start_rec_time[2];
	assign start_rec_time_3 = start_rec_time[3];
